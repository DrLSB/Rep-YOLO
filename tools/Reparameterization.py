...
def Yolov7_reparameterization(ckpt_path, yaml_path, num_classes):
    ...
    torch.save(ckpt, r'E:\chengxu\paper2-MinePersonnel-Code\yolov7-main\runs\yolov711.pt')

if __name__ == "__main__":

    parser = argparse.ArgumentParser(description='yolov7 trained model reparameterization')
    parser.add_argument('--ckpt', default=r'E:\chengxu\paper2-MinePersonnel-Code\yolov7-main\runs\train\v7_results\exp_yuan_B8_Epoch200\weights\best.pt', type=str, help='ckpt path')
    parser.add_argument('--device', type=str, default='0', help='gpu device,0,1,2..., or cpu')
    parser.add_argument('--yaml_path', type=str, default=r'E:\chengxu\paper2-MinePersonnel-Code\yolov7-main\cfg\deploy\yolov7.yaml', help='yaml file path')
