...
#
#         # partition windows
#         # print('x_windows_前',x.shape)
#         x_windows = window_partition(shifted_x, self.window_size)  # nW*B, window_size, window_size, C  (其中 nW=(W//window_size))
#         # print('x_windows_后',x_windows.shape)
#
#         # ----------------#
...
#
#         concate = self.softmax(torch.cat([energy_H, energy_W], 4))  # size = (b, num_heads, h ,w , h+w) #softmax归一化
...
class SwinTransformerLayer_vertical(nn.Module):
    ...
    def forward(self, x):
        ...
        x_windows = window_partition(shifted_x,
                                     self.window_size)  # nW*B, window_size, window_size, C  (其中 nW=(W//window_size))
        # print('x_windows_后',x_windows.shape)
