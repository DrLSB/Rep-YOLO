...
def plot_one_box(x, img, color=None, label=None, line_thickness=3):
    ...
    if label:
        ...
        c2 = c1[0] + t_size[0] - 40, c1[1] - t_size[1] - 3
        cv2.rectangle(img, (int(x[0]-40), int(x[1])), c2, color, -1, cv2.LINE_AA)  # filled
        cv2.putText(img, label, (c1[0]-40, c1[1] - 4), 0, tl / 3, [225, 255, 255], thickness=tf, lineType=cv2.LINE_AA)
