...
if __name__ == '__main__':
    ...
    parser.add_argument('--cfg', type=str, default=r'H:\Rep-YOLO\cfg\training\Rep-YOLO.yaml', help='model.yaml path')
    parser.add_argument('--data', type=str, default='data/Rep-YOLO_MPdataset.yaml', help='data.yaml path')
